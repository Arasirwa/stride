...
const Home = () => {
  ...
  const heroSlides = products.length >= 3 ? products.slice(0, 3) : [...products, ...products];
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="animate-pulse flex flex-col items-center">
          ...
          <p className="mt-4 text-primary-600 font-medium">Loading amazing products...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-secondary-50 to-secondary-100">
              ...
              <div className="absolute inset-0 flex items-center z-20">
                <div className="container mx-auto px-6">
                  ...
                  >
                    ...
                    <p className="text-xl mb-8 text-secondary-100 max-w-xl">
                      {product.description}
                    </p>
                    <div className="flex flex-wrap gap-4">
                      <Link
                        to={`/product/${product.id}`}
                        className="px-8 py-4 bg-accent-500 hover:bg-accent-600 rounded-xl text-white font-medium transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                      >
                        Shop Now
                      </Link>
                      <Link
                        to="/shop"
                        className="px-8 py-4 bg-white/20 backdrop-blur-sm hover:bg-white/30 rounded-xl text-white font-medium border border-white/30 transition-all"
                      >
                        View Collection
                      </Link>
                    </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            {[
              { name: "Sneakers", image: "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&w=600" },
              { name: "Casual", image: "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?auto=format&fit=crop&w=600" },
              { name: "Running", image: "https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?auto=format&fit=crop&w=600" },
              { name: "Basketball", image: "https://images.unsplash.com/photo-1579338559194-a162d19bf842?auto=format&fit=crop&w=600" }
            ].map((category) => (
              <motion.div
                key={category.name}
              ...
              >
                <div className="aspect-ratio aspect-w-1 aspect-h-1">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 w-full">
                    <h3 className="text-xl md:text-2xl font-bold text-white font-heading">{category.name}</h3>
                    <p className="text-white/80 mt-1 transform translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all">Explore Collection →</p>
                  </div>
                </div>
              </motion.div>
            ))}
            ...
            {featuredProducts.map((product) => (
              ...
              >
                <Link to={`/product/${product.id}`} className="block">
                  ...
                  <div className="p-6">
                    <div className="text-sm text-accent-600 font-medium mb-1">{product.brand}</div>
                    <h3 className="text-lg font-semibold text-secondary-900 mb-2 line-clamp-1">{product.name}</h3>
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center text-primary-500">
                        ...
                        <span className="text-xs text-secondary-500">({product.reviews?.length || 0})</span>
                      </div>
                    </div>
                  </div>
                </Link>
                ...
                >
                  <div className="flex items-center mb-6">
                    ...
                    <div className="ml-4">
                      ...
                      <div className="text-primary-300 text-sm">Verified Buyer</div>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-accent-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            >
              Sign up for exclusive offers, new releases, and 10% off your first order.
            </motion.p>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <p className="text-center text-secondary-500 mb-6 text-sm font-medium">TRUSTED BY LEADING BRANDS</p>
          <div className="flex flex-wrap justify-center items-center gap-10 opacity-60">
            {["Nike", "Adidas", "Puma", "New Balance", "Reebok", "Under Armour"].map((brand) => (
              <div key={brand} className="text-2xl font-bold text-secondary-400">
                {brand}
              </div>
            ))}
          </div>
